...
class SetNode extends Component {
  ...
  chooseNode() {
    Alert.alert(
      ...
      [
        {
          text: 'wss://serinus-5.kusama.network/',
          onPress: () => {
            this.setState({ chooseNode: 'wss://serinus-5.kusama.network/' })
          },
          style: 'cancel'
        },
        {
        ...
        { text: i18n.t('Profile.Cancel'), onPress: () => {}, style: 'cancel' },
        {
          ...
          onPress: () => {
            ;(async () => {
              ...
              // ensure api is exist
              if (this.props.rootStore.stateStore.API.hasOwnProperty('disconnect')) {
                this.props.rootStore.stateStore.API.disconnect()
              }
