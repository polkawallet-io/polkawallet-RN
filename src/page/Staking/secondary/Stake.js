  ...
  render() {
    return (
      <SafeAreaView style={styles.container}>
        ...
        >
          <Header title={i18n.t('Staking.Validate')} theme="dark" navigation={this.props.navigation} />
        </View>
            ...
            <View style={{ width: ScreenWidth - 40, marginLeft: 20, marginBottom: 20 }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <TextInput
                  ...
                  onChangeText={this.onChangeUnstakeThreshold.bind(this)}
                />
              </View>
              ...
              >
                <TextInput
                  ...
                  placeholderTextColor="#666666"
                  underlineColorAndroid="#ffffff00"
                  onChangeText={this.onChangeValidatorPayment.bind(this)}
                />
                <View
                  style={{
                    width: 105,
