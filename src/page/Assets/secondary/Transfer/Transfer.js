...
const SignaturePayload = require('@polkadot/types').default
...
class Transfer extends Component {
        ...
        NetInfo.isConnected.fetch().then(isConnected => {
          if (isConnected) {
            ...
            ;(async () => {
              ...
              const address = this.props.rootStore.stateStore.currentAccount.address
  ...
  componentWillMount() {
    ;(async () => {
      this.props.rootStore.stateStore.tocamera = 1
      polkadotAPI.freeBalance(this.props.rootStore.stateStore.currentAccount.address, balance => {
        this.setState({
          balance: balance
        })
      })
