...
const Actives_fixed=[
  {name:'councilVoting.setCooloffPeriod',time:'310',number:49,Aye:5042964,aye:368,Nay:2512889,nay:58,result:'Pass',Actives_Nofixed:[{name:'blocks:Compact<BlockNumber>',num:256}]},
  {name:'councilVoting.setCooloffPeriod',time:'310',number:48,Aye:5042964,aye:368,Nay:2512889,nay:58,result:'NoPass',Actives_Nofixed:[{name:'Compact<BlockNumber>',num:252}]},   
  {name:'councilVoting.setCooloffPeriod',time:'310',number:47,Aye:5042964,aye:368,Nay:2512889,nay:58,result:'Pass',Actives_Nofixed:[{name:'who:Address',num:'5rgjhfdkjgbfdkjvbcvbkdjvbdfghjsdffd'},{name:'free:Compact<Balance>',num:18000},{name:'reserved:Compact<Balance>',num:180000}]},  
]
              ...
              return(
                <View style={{borderBottomWidth:1,borderColor:'#C0C0C0',}} key={index}>
                  ...
                  <View style={{alignItems:'center',flexDirection:'row',marginTop:ScreenHeight/70,marginLeft:ScreenWidth/40,height:ScreenHeight/30}}>
                    ...
                    <View style={{flex:1}}/>
                    <Text style={{marginRight:ScreenWidth/40,fontSize:ScreenHeight/65}}>The result of voting:</Text>
                    <View style={{borderRadius:ScreenHeight/200,marginRight:ScreenWidth/40,alignItems:'center',justifyContent:'center',backgroundColor:item.result=='Pass'?'#7ad52a':'#fb3232',height:ScreenHeight/30}}>
