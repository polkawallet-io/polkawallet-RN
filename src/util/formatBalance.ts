...
interface BalanceFormatter {
  (input?: number | string, withSi?: boolean, decimals?: number): string;
...
function _formatBalance (input?: number | string, withSi: boolean = true, decimals: number = defaultDecimals): string {
